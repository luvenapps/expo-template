      ...
      <SettingsSection title={t('settings.privacyTitle')}>
        {privacyUrl ? (
          ...
          <YStack gap="$3" width="100%">
            <Paragraph fontSize="$4" flex={1} flexWrap="wrap" marginBottom="$5">
              Last updated: January 28, 2026
            </Paragraph>
            <Paragraph color="$colorMuted" fontSize="$4" flex={1} flexWrap="wrap" marginBottom="$5">
              Better Habits (&quot;the App&quot;) is operated by Luven LLC (&quot;we&quot;,
              ...
              the App. By using the App, you agree to the practices described in this Privacy
              Policy.
            </Paragraph>
            ...
            <Paragraph color="$colorMuted" fontSize="$4" flex={1} flexWrap="wrap">
              If you have questions or concerns about this Privacy Policy, contact us at: Email:
              support@luvenapps.com Company: Luven LLC Country: United States
            </Paragraph>
          </YStack>
        )}
      </SettingsSection>
